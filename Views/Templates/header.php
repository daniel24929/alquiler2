...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <img src="<?php echo base_url; ?>Assets/img/logo2.png" alt="Logo de FlexiDrive" height="100"> </a>
        <!-- Sidebar Toggle-->
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="<?php echo base_url; ?>Administracion">Nosotros</a>
                            </nav>
                        </div>
                        <?php } ?>
                        ...
                        <a class="nav-link" href="<?php echo base_url; ?>Administracion/mision_vision">
                            <div class="sb-nav-link-icon"><i class="fas fa-bullseye fa-2x"></i></div>
                            Quienes Somos
                        </a>
                        <a class="nav-link" href="<?php echo base_url; ?>Administracion/herramientas">
                            <div class="sb-nav-link-icon"><i class="fas fa-bullseye fa-2x"></i></div>
                            Herramientas
                        </a>
                    </div>
